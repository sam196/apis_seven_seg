...
// ============================================
// 👉 Give each ESP8266 its unique ID
const char* deviceID = "device2";   // Change to "device2" for your 2nd unit

// ============================================
// SERVER CONFIGURATION (Hosted on Render)
// ============================================
String serverHost = "https://sevensegment.onrender.com/message?id=" + String(deviceID);
...
String fetchMessage() {
  ...
  client.setInsecure();  // ✅ allows HTTPS without certificate validation
  HTTPClient http;
...
void updateDisplay() {
  ...
  currentDigit = (currentDigit + 1) % NUM_DIGITS;  // ✅ fixed
}
